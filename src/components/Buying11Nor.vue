...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <p style = "font-weight: bold; font-size: 25px">Giá 7.500.000 VNĐ</p>
        <label>
                    ...
                    <select name="selection" v-model="text5">
                        ...
                        <option value="Tím">Cam</option>
                    </select>
        </label>           
        <br><img src="../assets/iphone11nor.png" style="max-width:70% "/><br>
