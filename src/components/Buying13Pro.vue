...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <p style = "font-weight: bold; font-size: 25px">Giá 24.500.000 VNĐ</p>
        <label>
        ...
        <img src="../assets/iphone13pro.png" style="max-width:70% "/><br>
