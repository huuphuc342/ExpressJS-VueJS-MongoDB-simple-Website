...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <p style = "font-weight: bold; font-size: 25px">Giá 9.500.000 VNĐ</p>
        <label>
        ...
        <br><img src="../assets/iphonexsmax.png" style="max-width:60% "/><br>
