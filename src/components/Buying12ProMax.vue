...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <p style = "font-weight: bold; font-size: 25px">Giá 21.500.000 VNĐ</p>
        <label>
       ...
       <br><img src="../assets/iphone12promax.png" style="max-width:50% "/><br>
...
return {
    ...
    text2: '',
    text3: '',
    text4: 'Iphone 12 Pro Max',
    text5:'',
    text6: '21.500.000 VNĐ',
};
} ,
async created(){
try{
