...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <p style = "font-weight: bold; font-size: 25px">Giá 18.500.000 VNĐ</p>
        <label>
       ...
       <br><img src="../assets/iphone12pro.png" style="max-width:70% "/><br>
