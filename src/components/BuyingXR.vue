...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <input type="text" id="create-post4" v-model="text4" placeholder="Sản phẩm mua" disabled>
         <input type="text" id="create-test" v-model="username">
        <p style = "font-weight: bold; font-size: 25px">Giá 6.500.000 VNĐ</p>
        ...
        <br><img src="../assets/iphonexr.png" style="max-width:70% "/><br>
        <p style = "font-weight: bold; font-size: 20px"> Vui lòng thanh toán khi nhận hàng!</p>
...
methods: {
    ...
    await BuyingFunction.insertPost(this.text,this.text2,this.text3,this.text4,this.text5,this.text6,this.username);
    this.posts = await BuyingFunction.getPosts();
    },
