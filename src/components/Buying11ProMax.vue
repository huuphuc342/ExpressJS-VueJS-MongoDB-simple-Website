...
<h1>Xác nhận mua hàng</h1>
    <div class="create-post">
        ...
        <p style = "font-weight: bold; font-size: 25px">Giá 15.500.000 VNĐ</p>
        <label>
       ...
       <br><img src="../assets/iphone11promax.png" style="max-width:70% "/><br>
...
return {
    ...
    text2: '',
    text3: '',
    text4: 'Iphone 11 Pro Max',
    text5:'',
    text6: '15.500.000 VNĐ'
};
} ,
async created(){
try{
